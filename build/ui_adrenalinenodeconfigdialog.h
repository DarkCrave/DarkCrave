...
public:
    ...
    {
        AdrenalineNodeConfigDialog->setWindowTitle(QApplication::translate("AdrenalineNodeConfigDialog", "DarkCrave Node Configuration Template", 0));
#ifndef QT_NO_TOOLTIP
        detailText->setToolTip(QApplication::translate("AdrenalineNodeConfigDialog", "<html><head/><body><p>This pane shows an example DarkCrave.conf template with the necessary masternode settings.</p></body></html>", 0));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
