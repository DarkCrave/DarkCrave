...
{
    resize(798, 640);
    setWindowTitle(tr("DarkCrave") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("DarkCrave");
    setStyleSheet("#DarkCrave { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #dedede, stop: 1 #efefef);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a DarkCrave address"));
    ...
    masternodeManagerAction = new QAction(QIcon(":/icons/masternode_new"), tr("&DarkCravenodes"), this);
    masternodeManagerAction->setToolTip(tr("Show DarkCrave Nodes status and configure your nodes."));
    ...
    aboutAction = new QAction(tr("&About DarkCrave"), this);
    aboutAction->setToolTip(tr("Show information about DarkCrave"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for DarkCrave"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setIconSize(QSize(150,41));
    toolbar->setObjectName("tabs");
    toolbar->setStyleSheet("QToolButton { color: #666666; } QToolButton:hover { background-color: #666666 } QToolButton:checked { background-color: #666666 } QToolButton:pressed { background-color: #000000 } #tabs { color: #ffffff; background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 0.6, stop: 0 #404040, stop: 1 #101010);  }");
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("DarkCrave client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("DarkCrave client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DarkCrave network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid DarkCrave address or malformed URI parameters."));
    }
