...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeDarkCraveAmount"))
        settings.setValue("nAnonymizeDarkCraveAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeDarkCraveAmount = settings.value("nAnonymizeDarkCraveAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeDarkCraveAmount"))
        SoftSetArg("-anonymizeDarkCraveamount", settings.value("nAnonymizeDarkCraveAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizeDarkCraveAmount:
            nAnonymizeDarkCraveAmount = value.toInt();
            settings.setValue("nAnonymizeDarkCraveAmount", nAnonymizeDarkCraveAmount);
            emit anonymizeDarkCraveAmountChanged(nAnonymizeDarkCraveAmount);
            break;
        default:
            break;
        }
