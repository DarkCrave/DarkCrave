...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 DCC"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 DCC"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 DCC"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 DCC"));
