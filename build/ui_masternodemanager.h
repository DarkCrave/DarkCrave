...
public:
    ...
    void retranslateUi(QWidget *MasternodeManager)
    {
        ...
        label_2->setText(QApplication::translate("MasternodeManager", "DarkCrave Node Count:", 0));
        countLabel->setText(QApplication::translate("MasternodeManager", "0", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("MasternodeManager", "DarkCrave Network", 0));
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("MasternodeManager", "My DarkCrave Nodes", 0));
    } // retranslateUi
