...
QT_MOC_LITERAL(8, 131, 31)
    ...
    "anonymizeDarkCraveAmountChanged\0"
};
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->anonymizeDarkCraveAmountChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (OptionsModel::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsModel::anonymizeDarkCraveAmountChanged)) {
                *result = 5;
            }
        }
    }
...
// SIGNAL 5
void OptionsModel::anonymizeDarkCraveAmountChanged(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
