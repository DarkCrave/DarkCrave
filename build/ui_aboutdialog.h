...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About DarkCrave", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>DarkCrave</b> version", 0));
...
"Copyright \302\251 2014 The DarkCrave developers", 0));
