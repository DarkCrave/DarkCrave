...
""));
        ...
        labelBalance->setText(QStringLiteral("0 DCC"));
        ...
        labelStake->setText(QStringLiteral("0 DCC"));
        ...
        labelUnconfirmed->setText(QStringLiteral("0 DCC"));
        ...
        labelImmature->setText(QStringLiteral("0 DCC"));
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the DarkCrave network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
        ...
        labelAnonymized->setText(QApplication::translate("OverviewPage", "0 DCC", 0));
        label_8->setText(QApplication::translate("OverviewPage", "Amount and Rounds:", 0));
        labelAmountRounds->setText(QApplication::translate("OverviewPage", "0 DCC / 0 Rounds", 0));
...
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the DarkCrave network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
